...
<div id="content-full">
	...
	<div class="center-highlight">
		<div id="container-calender" class="container">
			...
			<div id="full" class="clearfix">
					...
					<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
						<div class="entry clearfix post full">
                            ...
                            <!--<div id="embedded-calender">-->
                                <div id="container-aboutpage" class="container">
			                        <div id="full" class="clearfix about-clearfix">
                                        <iframe src="https://www.google.com/calendar/embed?src=vfot1h1682mg47q2rido0vgeos%40group.calendar.google.com&ctz=Asia/Jerusalem" style="border: 0" width="540" height="400" frameborder="0" scrolling="no"></iframe>
                                    </div>
                                </div>
                            <!--</div>-->
