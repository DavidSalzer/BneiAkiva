...
<div id="content-full">
	...
	<div class="center-highlight">
		<div class="container big-wrap-galpage">

			<div id="full" class="clearfix my-own-gall">
					...
					<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
						<div class="entry clearfix post full">
							...
							<h1 class="title" id="title-khilagal"><?php the_title(); ?></h1>
 ...
 <script>
     ...
     h = d - a - b-55;
     jQuery('#full').css('min-height', h + 'px');
    </script>